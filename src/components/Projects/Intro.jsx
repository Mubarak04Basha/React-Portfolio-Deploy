  ...
  return (
    ...
    >
      ...
      <p className="text-center text-xl mt-4">
        Hi, {`I'm`} Mubarak Basha and I love making projects. I enjoy learning
        new skills and technologies, and applying them to create cool and useful
        solutions. You can check them out on my GitHub page{' '}
        <Link className="font-bold" to={`https://github.com/Mubarak04Basha`}>
          @Mubarak Basha{' '}
        </Link>{' '}
